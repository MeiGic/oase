    ...
    Waterfall.prototype = {
        ...
        _getColumns : function() {
            var options = this.options,
                ...
                containerWidth = $container.width(),//$container[0].tagName === 'BODY' ? $container.width() - 20 : $container.width(),  // if $container[0].tagName === 'BODY', fix browser scrollbar
        ...
        _requestData: function(callback) {
            ...
            $.ajax({
                ...
                error: function(jqXHR, textStatus, errorThrown) {
                    self._responeseError(jqXHR, textStatus, errorThrown);
                }
            });
        },
         ...
         * reponse error
         */
        _responeseError: function(xhr, textStatus, errorThrown) {
